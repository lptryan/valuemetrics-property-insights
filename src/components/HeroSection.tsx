  ...
  return (
    <section className="bg-slate-bg min-h-[calc(100vh-64px)] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-[680px] text-center space-y-7 animate-fade-in">
          {/* Eyebrow */}
          <p
          ...
          {/* H1 */}
          <h1 className="text-navy font-bold font-primary leading-tight" style={{ fontSize: "52px" }}>
            What is your home worth?
          </h1>

          {/* Subhead */}
          <p className="text-mid font-primary max-w-[520px] mx-auto leading-relaxed" style={{ fontSize: "18px" }}>
          ...
          {/* Trust bar */}
          <div className="flex items-center justify-center gap-0 h-12 text-mid" style={{ fontSize: "13px" }}>
